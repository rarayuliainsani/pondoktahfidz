...
// Form open
echo form_open_multipart(base_url('admin/pengajar/edit/'.$pengajar->idpengajar), ' class="form-horizontal"');
?>
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input type=date name=tgl_lahir class="form-control"  placeholder="Tanggal Lahir" value="<?php echo $pengajar->tgl_lahir ?>" >
  </div>
  </div>
...
<div class="form-group">
 ...
 <div class="form-group">
  ...
  <div class="col-md-5">
    <input type="text" name=username class="form-control"  placeholder="Username" value="<?php echo $pengajar->username ?>" required>
  </div>
</div>
 ...
 <div class="form-group">
  ...
  <div class="col-md-5">
    <input type="password" name=password class="form-control"  placeholder="Password" value="<?php echo $pengajar->password ?>" required>
  </div>
</div>
