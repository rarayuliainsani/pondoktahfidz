...
// Form open
echo form_open(base_url('pengajar/surat/edit/'.$surat->idsurat), ' class="form-horizontal"');
?>
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input type="text" name=jumlah_ayat class="form-control"  placeholder="Jumlah Ayat" value="<?php echo $surat->jumlah_ayat ?>" required>
  </div>
</div>
