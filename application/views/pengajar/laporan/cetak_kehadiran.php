...
<table style="width: 100%;">
  ...
  <hr class="line-title">
     <center><p><span style="font-size: 16px;  font-weight: bold;">LAPORAN KEHADIRAN</span></p>
     </center><br><br>
<table>
...
<br><br>
 ...
 <?php foreach($detail as $key => $result):?>
    <tr>
                ...
                <td><?php echo $result['hadir'];?></td>
                <td><?php echo $result['izin'];?></td>
                <td><?php echo $result['alfa'];?></td>
                <td><?php echo $result['sakit'];?></td>
  ...
  <?php endforeach;?>
          ...
          <!--   <tr>
                <td colspan="4" style="padding: 25px;" align="center"><b>Total Pendapatan</b></td>
