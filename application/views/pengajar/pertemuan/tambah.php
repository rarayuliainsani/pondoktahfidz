...
// Form open
echo form_open(base_url('pengajar/pertemuan/tambah'), ' class="form-horizontal"');
?>
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input type="text" name=pertemuanke class="form-control"  value="<?php echo set_value('pertemuanke') ?>" required>
  </div>
</div>
