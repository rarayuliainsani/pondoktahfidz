<p>
	<a href="<?php echo base_url('bendahara/spp/tambah') ?>" class="btn btn-success btn-lg">
...
<table class="table table-bordered" id="example1">
	...
	<tbody>
		...
		<tr>
			...
			<a href="<?php echo base_url('bendahara/spp/history/'.$spp->idspp) ?>" class="btn btn-success btn-xs" "><i class="fa fa-file"></i>History</a>
