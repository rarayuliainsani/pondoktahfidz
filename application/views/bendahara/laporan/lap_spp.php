                ...
                <div class="row">
                    ...
                    <div class="right_col" role="main">
                         <div class="card-header bg-danger" >
                               <center> <strong class="card-title text-white"> <h3>Laporan SPP</h3></strong></center>
                         </div>
                     <div class="card-body">
                    <div id="body">
                        <form action="<?php echo site_url('laporan_spp/filter_date') ?>" method="POST" target="_blank">
